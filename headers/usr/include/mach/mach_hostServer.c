...
#pragma pack(4)
	...
	typedef struct {
		mach_msg_header_t Head;
	} __Request__host_ipc_hash_info_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack()
#endif
...
#pragma pack(4)
	...
	typedef struct {
		...
		NDR_record_t NDR;
		mach_msg_type_number_t infoCnt;
	} __Reply__host_ipc_hash_info_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack()
#endif
...
#endif
	typedef __Request___host_page_size_t __Request;
	typedef __Reply___host_page_size_t Reply __attribute__((unused));
...
#endif
	typedef __Request__host_zone_info_t __Request;
	typedef __Reply__host_zone_info_t Reply __attribute__((unused));
...
mig_internal kern_return_t __MIG_check__Request__host_ipc_hash_info_t(__attribute__((__unused__)) __Request__host_ipc_hash_info_t *In0P)
{
...
#pragma pack()
#endif
	typedef __Request__host_ipc_hash_info_t __Request;
	typedef __Reply__host_ipc_hash_info_t Reply __attribute__((unused));
	...
	RetCode = host_ipc_hash_info(In0P->Head.msgh_request_port, (hash_info_bucket_array_t *)&(OutP->info.address), &OutP->infoCnt);
	if (RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, RetCode);
	}
	OutP->info.size = OutP->infoCnt * 4;
	...
	(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP)
{
	...
	if ((InHeadP->msgh_id > 220) || (InHeadP->msgh_id < 200) ||
